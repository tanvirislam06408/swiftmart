    ...
    <section className="w-full overflow-hidden bg-[#0E1F2B]">
      ...
      >
        ...
        <div className="relative z-10 mx-auto flex h-full min-h-[420px] max-w-7xl flex-col items-center justify-center px-6 py-16 text-center md:px-12 lg:px-20">
          <span className="inline-flex items-center gap-1.5 rounded-full border border-[#14B8A6]/30 bg-[#14B8A6]/20 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-[#14B8A6]">
          ...
          <h2 className="mt-5 text-4xl font-extrabold leading-tight tracking-tight text-white sm:text-5xl lg:text-6xl">
            Ready for a<br />
            <span className="text-[#14B8A6]">premium</span> experience?
          </h2>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <Link
              href="/explore"
              className="group inline-flex items-center gap-2 rounded-full bg-gradient-to-br from-[#14B8A6] to-[#14B8A6]/80 px-7 py-3 text-sm font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-95"
              style={{ boxShadow: "0 8px 24px rgba(20,184,166,0.27)" }}
            >
              Start Shopping
              <svg
