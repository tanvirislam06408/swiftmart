...
export default function SlideContent({
  ...
  return (
    <div className="relative z-10 mx-auto flex h-full min-h-[560px] md:min-h-[600px] max-w-7xl flex-col items-center justify-center gap-10 px-6 py-16 md:flex-row md:px-12 lg:px-20">
