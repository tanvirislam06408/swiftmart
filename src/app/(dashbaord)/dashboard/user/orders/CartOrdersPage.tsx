    ...
    <div className="w-full max-w-7xl mx-auto px-4 md:px-8 py-6 md:py-10 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-300">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-100 pb-5">
        <div className="space-y-1">
          ...
          <p className="text-gray-500 text-sm">Review your selected experiences and secure bookings.</p>
        </div>
      ...
      {cart.length === 0 ? (
            ...
            {cart.map((item) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0 text-center sm:text-left space-y-1">
                  ...
                  <h4 className="font-bold text-gray-800 text-sm truncate group-hover:text-[#14B8A6] transition-colors">{item.title}</h4>
                  <p className="text-xs text-gray-400 truncate">{item.location} • {item.duration}</p>
                </div>
        ...
        <div className="card-base p-8 md:p-12 text-center max-w-2xl mx-auto border border-emerald-100 bg-emerald-50/10 shadow-lg space-y-8 animate-in zoom-in-95 duration-300">
          ...
          <div className="card-base bg-white p-6 max-w-md mx-auto border border-gray-100 shadow-sm text-left space-y-4 text-xs">
            ...
            {/* Items summary */}
            <div className="space-y-2">
              <span className="text-[9px] text-gray-400 font-bold block uppercase tracking-wider">Booked Experience Slots</span>
              {cart.map(item => (
